...
public class HexadecimalSudokuTest {
  ...
  public static void main(String[] arg) {
    ...
    int[][] myExample = { {11, 2, 5, 7, 4, 10, 9, 15, 6, 14, 0, 1, 12, 3, 8, 13 },
      { 14, 4, 0, 9, 11, 8, 2, 12, 13, 5, 3, 10, 15, 1, 7, 6 },
      { 1, 10, 15, 12, 6, 13, 7, 3, 4, 9, 8, 3, 11, 5, 14, 0 },
      { 13, 8, 6, 3, 5, 14, 1, 0, 11, 7, 15, 12, 10, 9, 4, 2 },
      { 0, 7, 14, 2, 8, 11, 4, 9, 1, 6, 10, 5, 13, 12, 3, 15 },
      { 3, 5, 9, 1, 10, 12, 14, 7, 2, 4, 13, 15, 8, 0, 6, 11 },
      { 12, 15, 10, 13, 2, 1, 3, 6, 8, 11, 14, 0, 7, 4, 5, 9 },
    ...
    testSudoku("my example", myExample, null); // selfmade testcase
    testSudoku("example 1", example1, solution1); // given testcase
    testSudoku("example 2", example2, solution2); // given testcase
    testSudoku("Hard", example3, null); // given testcase
    testSudoku("Harder/Impossible?", example4, null); // given testcase
